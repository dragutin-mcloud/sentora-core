...
class module_controller extends ctrl_module
{
	...
	static function getisShowLE()
	{
		global $controller;
		$urlvars = $controller->GetAllControllerRequests('URL');
		return (isset($urlvars['show'])) && ($urlvars['show'] == "ShowLE");
	}
	...
	static function doselect()
	{
		...
		if (isset($formvars['inLetsEncrypt'])) {
			header("location: ./?module=" . $controller->GetCurrentModule() . '&show=ShowLE');
			exit;
		}
		return true;
	}
